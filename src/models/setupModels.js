...
export default async function setupModels() {
  ...
  await User.bulkCreate([
    { email: 'user1@gmail.com', name: 'User 1', score: 0 },
    { email: 'user2@gmail.com', name: 'User 2', score: 0 },
    { email: 'user3@gmail.com', name: 'User 3', score: 0},
    { email: 'user4@gmail.com', name: 'User 4', score: 0 },
    { email: 'user5@gmail.com', name: 'User 5', score: 0 },
  ]);
